...
public class CardSystem extends BaseComponentSystem {
    ...
    public void placeCard(ActivateEvent event, EntityRef entity) {
        ...
        worldProvider.setBlock(bottomBlockPos, card.bottomBlockFamily.getBlockForPlacement(new BlockPlacementData(bottomBlockPos, facingDir, new Vector3f(Side.TOP.direction()))));
        worldProvider.setBlock(topBlockPos, card.topBlockFamily.getBlockForPlacement(new BlockPlacementData(topBlockPos, facingDir, new Vector3f(Side.TOP.direction()))));
