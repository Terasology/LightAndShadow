...
public class FloatingPlatformRasterizer implements WorldRasterizerPlugin {
    ...
    private static final Block RED_DICE = CoreRegistry.get(BlockManager.class).getBlock("LightAndShadowResources" +
            ":redDice");
    private static final Block BLACK_DICE = CoreRegistry.get(BlockManager.class).getBlock("LightAndShadowResources" +
            ":blackDice");
